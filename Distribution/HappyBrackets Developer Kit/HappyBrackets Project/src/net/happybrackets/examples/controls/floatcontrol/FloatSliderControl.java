package net.happybrackets.examples.controls.floatcontrol;
...
public class FloatSliderControl implements HBAction {
    ...
    public void action(HB hb) {
         ...
         *************************************************************/
        hb.createDynamicControl(this, ControlType.FLOAT, "Frequency", CENTRE_FREQUENCY, CENTRE_FREQUENCY - FREQUENCY_VARIATION, CENTRE_FREQUENCY + FREQUENCY_VARIATION)
         ...
         * Simply type floatSliderControl to generate this code
         *************************************************************/
        hb.createDynamicControl(this, ControlType.FLOAT, "Gain", MAX_VOLUME, 0, MAX_VOLUME)
                .addControlListener(control -> {
                    float control_val = (float) control.getValue();
