...
/**
 * THis skecth will show you how to change from different float control displays
 */
public class ChangeControlTypes implements HBAction {
    ...
    public void action(HB hb) {
        ...
        FloatControl floatControl = new FloatControl(this, "Float Control", 0){
            @Override
        ...
        TriggerControl setBuddy = new TriggerControl(this, "Set Buddy") {
            ...
            public void triggerEvent() {// Write your DynamicControl code below this line
                floatControl.setDisplayRange(-1, 1, DynamicControl.DISPLAY_TYPE.DISPLAY_ENABLED_BUDDY);
                // Write your DynamicControl code above this line
            }
        ...
        TriggerControl setSlider = new TriggerControl(this, "Set Slider") {
            ...
            public void triggerEvent() {// Write your DynamicControl code below this line
                ...
                floatControl.setDisplayRange(-1, 1, DynamicControl.DISPLAY_TYPE.DISPLAY_DEFAULT);
                // Write your DynamicControl code above this line
            }
        ...
        TriggerControl setText = new TriggerControl(this, "Set Text") {
            ...
            public void triggerEvent() {// Write your DynamicControl code below this line
                ...
                floatControl.setDisplayRange(0, 0, DynamicControl.DISPLAY_TYPE.DISPLAY_DEFAULT);
                // Write your DynamicControl code above this line
            }
