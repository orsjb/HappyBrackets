...
### Script to upload startup classes to PI by automating the scp command
...
# run scp
    ...
    do
        ...
        then
            ...
            expect_password "sh -c \"scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -r classes/* $HOST_ADDRESS:~/HappyBrackets/data/classes/\""
            ...
            scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -r $FILE_PATH/classes/* $HOST_ADDRESS:~/HappyBrackets/data/classes/
