 ...
 * in some systems
 */
public class DebuggerWaveformVisualizer extends JPanel {
     ...
     * Constructor
     */
    private DebuggerWaveformVisualizer(){
    }
    ...
    /**
     * Create a {@link DebuggerWaveformVisualizer} that will be used to display audio waveform
     * The initial {@link AudioContext} is null so the object can be created without crashing the system
     * @return the {@link DebuggerWaveformVisualizer} we will later make call to {@link #setAudioContext(AudioContext)} to
     */
    public static DebuggerWaveformVisualizer createVisualiser() {

        DebuggerWaveformVisualizer visualizer = null;
        try {

            JFrame frame = new JFrame("Happy Brackets Output");

            visualizer = new DebuggerWaveformVisualizer();
            ...
            DebuggerWaveformVisualizer finalVisualizer = visualizer;
