 ...
 */
public class OLDBroadcastManager {
    ...
    public OLDBroadcastManager() {
        ...
        System.err.println("Warning: OLDBroadcastManager can't use multicast. No broadcast functionality available in this session.");
    }
    }
