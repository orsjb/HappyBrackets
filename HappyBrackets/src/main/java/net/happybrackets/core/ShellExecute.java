...
public class ShellExecute {
     ...
     * @param listener
     */
    public void addProcessCompleteListener(ProcessComplete listener){
     ...
     * @throws java.io.IOException thrown exeption if unable to run command
     */
    public void executeCommand(String cmd) throws java.io.IOException {
